...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/statics/minisns.svg" width="80%" style="max-width: unset;max-height: unset;">',

    'logo_url'=> '/statics/mlogo.svg',
    ...
    |
    */
    'logo-mini' => '<img src="/statics/mlogo.svg" style="width: 45px;">',
    ...
    /*
     ...
     |
     */
    'default_avatar' => '/statics/mlogo.svg',
   ...
   */
    ...
    */
    ...
    'https' => env('ADMIN_HTTPS', ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') || (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https')) ? true : false),
