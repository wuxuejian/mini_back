...
if ('web' == $env['php']['run_mode']) {
    ...
    $html_body_nav .= '<p class="lead">Version:'. WIZARD_VERSION . ' Date:2021-05-20</p>';
    ...
    if (!empty($env['php']['loaded_incompatible_extensions'])) {
		...
		';
        $err_msg = "当前PHP包含与swoole_loader扩展不兼容的扩展" . implode(',', $env['php']['loaded_incompatible_extensions']) . "，请移除不兼容的扩展。";
    ...
    if (empty($html_error)) {
        ...
        $html_body_loader .= '<p><span class="bold_text">1 - 下载Swoole Loader</span></p><p>请下载兼容PHP'
            . $env['php']['version'] . '和'
            . $env['php']['thread_safety']
            . '的Swoole Loader扩展，
<a target="_blank" href="https://compiler.swoole.com/encryptor/download/">点击直达下载页面</a></p>';
	...
	<p class="mb-1">CopyRight © 2018 - '. date('Y') . ' Swoole.com 昆山识沃网络科技有限公司</p>
  </footer>';
