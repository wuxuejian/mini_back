    ...
    var OffCanvas = function () {
        $('#off-canvas-toggle').on('click', function () {
            ...
            if (userinfo == '' || userinfo == null) {
                $('#not-log').removeClass('display-none');
            } else {
                $('#userinfo').removeClass('display-none');
                $('#user_bg').attr("src", userinfo.user_background_maps);
                $('#user_avatar').attr("src", userinfo.user_avatar);
                $('#user_name').html(userinfo.user_name);
                $('#follow_total').html(userinfo.followTotal);
                $('#fans_total').html(userinfo.fansTotal);
                $('#like_total').html(userinfo.likeTotal);
            }
        });
    ...
    var moreArticles = function () {
        $.fn.vwScroller = function (options) {
            ...
            var observer = $.proxy(function () {
                var isInViewPort = $document.scrollTop() > (($document.height() - $window
