(function () {
    ...
    SKU.prototype.SKUForm = function (default_sku, params) {
        ...
        if (attr_names.length === 0) {
            ...
            thead_html += '<th data-field="vip_price" style="width: 100px">vip用户价格 <input type="text" class="form-control"></th>';
            thead_html += '<th data-field="price" style="width: 100px">普通用户价格 <input type="text" class="form-control"></th>';
            ...
            cartesianProductOf.forEach(function (sku_item) {
                ...
                tbody_html += '<td data-field="vip_price"><input value="" type="text" class="form-control"></td>';
